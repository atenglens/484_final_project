...
class NSDSpanBasedF1Measure():
    ...
    def __call__(
        ...
        Params:
            ...
            - rose FF1A Bool FF0C Whether use the new metric —— restriction-oriented span evaluation (ROSE)
        ...
        for i in range(batch_size):
            ...
            if rose:
                ...
                for span in gold_ns_spans:
                    ...
                    tolerance = math.floor(proportion * (gold_span_end - gold_span_start + 1)) if (proportion * (gold_span_end - gold_span_start + 1)) > 1 else 1# gold span length >= tolerance
                    great_num = 0
