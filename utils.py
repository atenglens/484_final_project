...
def span_metric(true:list,predict:list):
    ...
    p_nsd = span_metrics["precision-nsd"]
    f_ind = span_metrics["f1-ind"]
    r_ind = span_metrics["recall-ind"]
    p_ind = span_metrics["precision-ind"]

    print(f"=====> Span(Experiment) <=====")
    print(f"NSD:  f:{f_nsd}, p:{p_nsd}, r:{r_nsd}\n")
    print(f"=====> Span(Experiment) <=====")
    print(f"IND:  f:{f_ind}, p:{p_ind}, r:{r_ind}\n")
...
def rose_metric(test_true_lines:list,test_pred_lines:list):
    ...
    rose_f1_25 = round(nsd_metrics_25["f1-nsd"], 2)
    rose_f1_50 = round(nsd_metrics_50["f1-nsd"], 2)
    rose_f1_75 = round(nsd_metrics_75["f1-nsd"], 2)
    rose_f1_100 = round(nsd_metrics_100["f1-nsd"], 2)
    rose_p_25 = round(nsd_metrics_25["precision-nsd"], 2)
    rose_p_50 = round(nsd_metrics_50["precision-nsd"], 2)
    rose_p_75 = round(nsd_metrics_75["precision-nsd"], 2)
    rose_p_100 = round(nsd_metrics_100["precision-nsd"], 2)
    rose_r_25 = round(nsd_metrics_25["recall-nsd"], 2)
    rose_r_50 = round(nsd_metrics_50["recall-nsd"], 2)
    rose_r_75 = round(nsd_metrics_75["recall-nsd"], 2)
    rose_r_100 = round(nsd_metrics_100["recall-nsd"], 2)
